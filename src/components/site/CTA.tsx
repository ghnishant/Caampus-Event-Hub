    ...
    <div className="mx-auto max-w-5xl px-6">
      ...
      >
        ...
        <p className="relative mt-5 text-lg text-primary-foreground/85 max-w-xl mx-auto">
          Join the student organizers already running smarter, smoother events with CampusHub.
        </p>
        <div className="relative mt-10 flex justify-center gap-3">
          <Button variant="glass" size="lg" className="bg-white text-foreground hover:bg-white/90 group">
            Start free
      ...
      <p className="mt-10 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} CampusHub · Crafted with care for student communities.
      </p>
    </div>
  </section>
);
